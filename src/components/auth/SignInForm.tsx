    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4 pt-[8vh] pb-10">
      ...
      <div className="w-[340px] overflow-hidden rounded-md border border-border bg-panel shadow-md">
        ...
        <form onSubmit={submit} className="p-5">
          <p className="mb-4 text-xs text-muted">Enter your 4-digit code to open your workspace.</p>
          ...
          {error && (
            <div
              role="alert"
              className="mb-3 rounded border border-danger/40 bg-danger/10 px-2.5 py-1.5 text-xs text-danger"
            >
              {error}
            </div>
          )}
